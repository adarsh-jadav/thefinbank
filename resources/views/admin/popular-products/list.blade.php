                   ...
                   <div class="col">
                       ...
                       <div class="col-auto">
                            ...
                            @if (in_array('5', $add_perm))
                                <a class="btn btn-primary me-1" href="{{ route('popularproducts.create') }}">
                                    <i class="fas fa-plus"></i> Add Popular Product
                                </a>
                            @endif
           ...
           <div class="row">
               <div class="col-sm-12">
                   <div class="card card-table">
                       <div class="card-body">
                           <form id="form" action="{{ route('delete-popular-product') }}" enctype="multipart/form-data">
                                               ...
                                               <tr>
                                                @if (in_array('5', $edit_perm))
                                                   ...
                                                   <td>
                                                    ...
                                                    <td>
                                                    @if($data->image != '')
                                                    <img src="{{ url('public/upload/popular-products/large/' . $data->image) }}"
                                                    ...
                                                    class="form-control" /></td>
                                                       ...
                                                       <td class="text-right">
                                                           <a class="btn btn-primary"
                                                               href="{{ route('popularproducts.edit', $data->id) }}"><i
           ...
           <div class="modal-content">
               <div class="modal-body">
                   ...
                   <div class="modal-text text-center">
                       <!-- <h3>Delete Expense Popular Product</h3> -->
   ...
   <!-- /Delete Modal -->
   <!-- Select one record Popular Product Modal -->
    ...
    <div class="modal custom-modal fade" id="set_order_model" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="modal-text text-center">
                        <h3>Are you sure you want to Set order of Popular Product</h3>
