       ...
       <div class="content container-fluid">
           ...
           <div class="page-header">
               <div class="row align-items-center">
                   <div class="col">
                       <h3 class="page-title">Enquiry Now</h3>
                       <ul class="breadcrumb">
                           <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a>
                           </li>
                           <li class="breadcrumb-item active">Enquiry Now</li>
                       </ul>
                   </div>
           ...
           <div class="row">
               <div class="col-sm-12">
                   <div class="card card-table">
                       <div class="card-body">
                           <form id="form" action="{{ route('delete-enquiries') }}" enctype="multipart/form-data">
           ...
           <div class="modal-content">
               <div class="modal-body">
                   ...
                   <div class="modal-text text-center">
                       <!-- <h3>Delete Expense Enquiry Now</h3> -->
   ...
   <!-- /Delete Modal -->
   <!-- Select one record Enquiry Now Modal -->
    ...
    <div class="modal custom-modal fade" id="set_order_model" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="modal-text text-center">
                        <h3>Are you sure you want to Set order of Enquiry Now</h3>
