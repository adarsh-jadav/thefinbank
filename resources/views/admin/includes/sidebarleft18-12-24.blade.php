<div class="sidebar-inner slimscroll">
    ...
    <div id="sidebar-menu" class="sidebar-menu">
        ...
        <ul>
           ...
           @if (in_array('4', $permission1) || in_array('5', $permission1) || in_array('6', $permission1) || in_array('7', $permission1) || in_array('8', $permission1))

                @if (in_array('6', $permission1))
                <li class="{{ request()->segment(2) == 'banner' ? 'active' : '' }}">
                    <a href="{{ route('banner.index') }}" class="{{ request()->segment(2) == 'banner' ? 'active' : '' }}"><i class="fa fa-file"></i><span>Banner</span></a>
                </li>
                @endif

                @if (in_array('4', $permission1))
                <li class="{{ request()->segment(2) == 'category' ? 'active' : '' }}">
                    <a href="{{ route('category.index') }}" class="{{ request()->segment(2) == 'category' ? 'active' : '' }}"><i class="fa fa-file"></i><span>Category</span></a>
                </li>
                @endif
                ...
                <li class="{{ request()->segment(2) == 'popularproducts' ? 'active' : '' }}">
                    ...
                    class="{{ request()->segment(2) == 'popularproducts' ? 'active' : '' }}"><i class="fa fa-file"></i><span>Popular Products</span></a>
                </li>
                @endif
                ...
                <li class="{{ request()->segment(2) == 'product' ? 'active' : '' }}">
                    ...
                    class="{{ request()->segment(2) == 'product' ? 'active' : '' }}"><i class="fa fa-file"></i><span>Product</span></a>
                </li>
                @endif
                ...
                <li class="{{ request()->segment(2) == 'enquiries' ? 'active' : '' }}">
                    ...
                    class="{{ request()->segment(2) == 'enquiries' ? 'active' : '' }}"><i class="fa fa-file"></i><span>Enquiry Now</span></a>
                </li>
                @endif
                @if (in_array('9', $permission1))
                <li class="{{ request()->segment(2) == 'contact-us' ? 'active' : '' }}">
                    <a href="{{ route('contact-us.index') }}"
                    class="{{ request()->segment(2) == 'contact-us' ? 'active' : '' }}"><i class="fa fa-file"></i><span>Contact Us</span></a>
                </li>
                @endif
            @endif
