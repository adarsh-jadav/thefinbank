                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="email" name="email" type="text" class="form-control"
                                        placeholder="Enter Email" value="{{ $adminuser->email }}" readonly/>
...
$("#department_id").select2();
        ...
        function category_validation() {
            ...
            //     jQuery('#department_id_error').html("Plaese Select Department.");
            //     jQuery('#department_id_error').show().delay(0).fadeIn('show');
            //     jQuery('#department_id_error').show().delay(2000).fadeOut('show');
            //     $('html, body').animate({
            //         scrollTop: $('#department_id').offset().top - 150
            //     }, 1000);
            //     return false;
            // }
