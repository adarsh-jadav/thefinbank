            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="product_form" action="{{ route('product.update', $product->id) }}" method="POST"
                            ...
                            <div class="row">
                                    ...
                                    <select id="category_id" name="category_id" class="form-control select">
                                        ...
                                        @foreach ($category as $cat_data)
                                            <option value="{{ $cat_data->id }}"
                                                {{ $cat_data->id == $product->category_id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($product->image != '')
                                        <img src="{{ asset('public/upload/products/' . $product->image) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($product->detail_image != '')
                                        <img src="{{ asset('public/upload/products/detail-banner/large/' . $product->detail_image) }}"
                                            style="width: 50px;height:50px;margin-top: -11px;" />
                                    @endif
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" id="key-features" name="key_features" class="form-control" placeholder="Enter Description">{{ $product->key_features }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="name">Details</label>
                                    <textarea type="text" id="details" name="details" class="form-control" placeholder="Enter Details">{{ $product->details }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="name">Documentation</label>
                                    <textarea type="text" id="documentation" name="documentation" class="form-control"
                                        placeholder="Enter Documentation">{{ $product->documentation }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="name">Fees & Charges</label>
                                    <textarea type="text" id="fees_charges" name="fees_charges" class="form-control"
                                        placeholder="Enter Fees & Charges">{{ $product->fees_charges }}</textarea>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="meta_keyword" name="meta_keyword" type="text" class="form-control"
                                            placeholder="Enter Meta Keyword" value="{{ $product->meta_keyword }}" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Meta Description</label>
                                        <textarea class="form-control" id="meta_description" name="meta_description" placeholder="Enter Short Description">{{ $product->meta_description }}</textarea>
                                    </div>
                                </div>
                            </div>
