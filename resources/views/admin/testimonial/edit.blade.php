    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form id="banner_form" action="{{ route('testimonial.update', $testimonial->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name" type="text" class="form-control"
                                        placeholder="Enter a Name" value="{{ $testimonial->name }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="designation" name="designation" type="text" class="form-control"
                                        placeholder="Enter a Designation" value="{{ $testimonial->designation }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ url('public/upload/testimonial/medium/' . $testimonial->image) }}"
                                        style="width: 10%; margin:15px;">
                                    <p class="form-error-text" id="image_error" style="color: red; margin-top: 10px;"></p>
                                </div>
                                <div class="form-group">
                                    <label for="name">Description</label>
                                    <textarea id="description" name="description" class="form-control" placeholder="Enter a Description" />{{ $testimonial->short_description }}</textarea>
                            ...
                            <div class="text-end mt-4">
                                ...
                                <button type="button" class="btn btn-primary" id="submit_button"
                                    onclick="javascript:banner_validation()">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
