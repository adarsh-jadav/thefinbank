            ...
            <div class="owl-carousel owl-theme">
                <div class="item">
                    <div class="portfolio-box">
                        ...
                        <div class="lower_portion_wrapper">
                            <a href="{{ route('products') }}" class="heading text-decoration-none"><h4>Unsecured Loans</h4></a>
                ...
                <div class="item">
                    <div class="portfolio-box">
                        ...
                        <div class="lower_portion_wrapper">
                            <a href="{{ route('products') }}" class="heading text-decoration-none"><h4>Secured Loans</h4></a>
                ...
                <div class="item">
                    <div class="portfolio-box">
                        ...
                        <div class="lower_portion_wrapper">
                            <a href="{{ route('products') }}" class="heading text-decoration-none"><h4>Other Loans</h4></a>
                ...
                <div class="item">
                    <div class="portfolio-box">
                        ...
                        <div class="lower_portion_wrapper">
                            <a href="{{ route('products') }}" class="heading text-decoration-none"><h4>Health Insurance</h4></a>
                ...
                <div class="item">
                    <div class="portfolio-box">
                        ...
                        <div class="lower_portion_wrapper">
                            <a href="{{ route('products') }}" class="heading text-decoration-none"><h4>Life Ins & Investments</h4></a>
