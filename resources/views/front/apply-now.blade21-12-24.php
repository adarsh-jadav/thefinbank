...
<style>
    ...
    <section class="position-relative">
        <div class="container position-relative">
            <div class="row">
			<img src="https://hnrtechnologies.com/thefinbank/public/upload/product-listing/1733131343product_details.png" alt="About Us" class="img-fluid">
                ...
                $.ajax({
                    ...
                    success: function(responses) {
                        if ($.trim(responses.message) == 'TRUE') {
                            $('#result').html(
                                '<div class="alert alert-success alert-dismissible mt-2"><a href="javascript:void(0);" class="close" data-dismiss="alert" aria-label="close" style="float: inline-end;">&times;</a><p style="color:#FFF;">Thank You. Contact us has been sent successfully.</p></div>'
                            );
                            $("#contactus_btn").show();
                            $("#loader-btn").hide();
