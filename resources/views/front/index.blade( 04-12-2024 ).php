                ...
                <div class="item">
                    <div class="portfolio-box">
                        <div class="upper_portion">
                            ...
                            @if($category->sub_title !="" && !empty($category->sub_title))
                            <span class="size-text-14">{{ $category->sub_title }}</span>
                            @endif
                        </div>
                        <div class="lower_portion_wrapper">
                            <a href="{{ route('loan',$category->page_url) }}" class="heading text-decoration-none"><h4>{{ $category->name }}</h4></a>
                            <p class="text-size-16">{!! Helper::getTwoLinesText($category->short_description) !!}</p>
                            <a class="learn_more text-decoration-none" href="{{ route('loan',$category->page_url) }}"><i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                @endforeach
