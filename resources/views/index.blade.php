...
.home-banner-slider .owl-nav,.portfolio-con .owl-nav {
    position: absolute;
    top: 45%;
    width: 100%;
...
.home-banner-slider .owl-nav .arrow,.portfolio-con .owl-nav .arrow {
    width: 40px;
    height: 40px;
...
.home-banner-slider .owl-nav .arrow.left,.hportfolio-con .owl-nav .arrow.left {
    position: absolute;
...
.portfolio-con .owl-nav .arrow.left {
    position: absolute;
    right: 102%; /* Adjust distance from the right edge */
}
.portfolio-con .owl-nav .arrow.right {
    position: absolute;
    left: 102%; /* Adjust distance from the right edge */
}

.home-banner-slider .owl-nav .arrow.right img,.home-banner-slider .owl-nav .arrow.left img,.portfolio-con .owl-nav .arrow.right img,.portfolio-con .owl-nav .arrow.left img{
    width: 90% !important;
}
                    ...
                    <div class="portfolio-box">
                        <div class="upper_portion">
                            <figure class="mb-0 portfolio-image">
                                ...
                                <img src="{{ asset('public/upload/popular-products/large/'.$data->image) }}" class="img-fluid" alt="image">
                                @else
                                <img src="{{ asset('public/upload/popular-products/large/noimage.jpg') }}" class="img-fluid" alt="image">
                                @endif
                            </figure>
                        ...
                        <div class="lower_portion_wrapper">
                            ...
                            <a href="{{ $data->link }}" target="_blank" class="heading text-decoration-none">
                            @else
                            <a href="{{ $data->link ?? "javascript:void(0);" }}" class="heading text-decoration-none">
                            @endif
                            <h4>{{ $data->name }}</h4></a>
                            <p class="text-size-16">{!! Helper::getTwoLinesText($data->short_description) !!}</p>
                            @if(!empty($data->link) && $data->link !="")
                            <a class="learn_more text-decoration-none" href="{{ $data->link }}" target="_blank">
                            @else
                            <a class="learn_more text-decoration-none" href="{{ $data->link ?? "javascript:void(0);" }}" >
                            @endif
...
<section class="service-con position-relative mt-5">
    <div class="container">
        ...
        <div class="col-lg-8 col-md-10 col-12 mx-auto">
            <div class="secure_content text-center">
                <a href="{{ route('product-all') }}" class="text-decoration-none all_button get_started">View All<i class="fa-solid fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
</section>
